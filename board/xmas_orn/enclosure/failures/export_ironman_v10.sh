...
mkdir -p stl/ironman_v10 docs
for colour in body gold black white; do
    target="stl/ironman_v10/ironman_${colour}.stl"
    "$OPENSCAD" --hardwarnings -q --export-format binstl \
        -D "part=\"${colour}_print\"" -o "$target" ironman_v10.scad
    echo "$target"
done
"$OPENSCAD" --hardwarnings -q --projection=o --colorscheme=Tomorrow \
    --imgsize=1100,1100 --camera=13.75,22.5,8.8,0,0,0,330 \
    -o docs/ironman_v10_front.png ironman_v10.scad
"$OPENSCAD" --hardwarnings -q --projection=o --colorscheme=Tomorrow \
    --imgsize=1100,1100 --camera=13.75,22.5,8.8,23,16,0,330 \
    -o docs/ironman_v10_iso.png ironman_v10.scad
echo "docs/ironman_v10_front.png"
echo "docs/ironman_v10_iso.png"
